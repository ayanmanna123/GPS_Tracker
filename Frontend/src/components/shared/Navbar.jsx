...
import { Navigation, Globe, Menu, X, Sparkles, ChevronDown, Brain } from "lucide-react";
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <div className={`relative group cursor-pointer ${scrolled ? 'scale-95' : ''} transition-transform`}>
              <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg transition-all ${darktheme
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <nav className="flex items-center gap-1">
              {[
                ...
                { path: "/predict/route", label: "AI Predict", icon: Brain },
              ].map((item) => (
                <button
                  key={item.path}
                  onClick={() => handleNavigation(item.path)}
                  className={`relative px-4 py-2 rounded-lg font-medium transition-all duration-200 ${isActiveRoute(item.path)
                      ? darktheme
                ...
                >
                  ...
                  {isActiveRoute(item.path) && (
                    <span className={`absolute bottom-0 left-1/2 -translate-x-1/2 w-8 h-1 rounded-full ${darktheme ? "bg-blue-500" : "bg-blue-600"
                      }`}></span>
                  )}
                </button>
              ))}
            ...
            {/* Live Badge */}
            <div className={`flex items-center gap-2 px-3 py-2 rounded-full border ${darktheme
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button className={`flex items-center gap-2 px-3 py-2 rounded-lg border transition-all ${darktheme
            ...
            {isAuthenticated ? (
              <Popover>
                <PopoverTrigger asChild>
                  <button className={`flex items-center gap-3 px-3 py-2 rounded-xl border transition-all ${darktheme
