...
const AboutUs = () => {
  ...
  const team = {
    creator: {
      ...
      description:
        "Passionate developer dedicated to transforming public transportation through innovative technology solutions.",
    ...
    values: [
      ...
      },
      {
        ...
        role: "Foundation",
        description:
          "Building robust systems that users can depend on every day",
        icon: Shield,
      },
      {
        name: "User-Centric",
        ...
        description:
          "Every feature designed with user experience and accessibility in mind",
        icon: Heart,
      },
    ],
  };
    ...
    const fetchContributors = async () => {
      try {
        const response = await fetch(
          "https://api.github.com/repos/ayanmanna123/GPS_Tracker/contributors",
        );
        if (!response.ok) {
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 relative z-10">
          ...
          >
            <div className="text-center mb-8">
              ...
              <motion.div className="mt-6" variants={itemVariants}>
                <p
                  className={`text-sm ${darktheme ? "text-gray-400" : "text-gray-600"} mb-3`}
                >
          ...
          >
            ...
            {loading ? (
              ...
              <div
                className={`text-center p-6 rounded-xl ${darktheme ? "bg-red-900/30" : "bg-red-100"}`}
              >
                ...
                {contributors.map((contributor) => (
                  ...
                  >
                    <div className="flex flex-col items-center">
                      ...
                      />
                      <h3
                        className={`font-semibold text-center truncate w-full ${darktheme ? "text-white" : "text-gray-900"}`}
                      >
                        {contributor.login}
                      </h3>
                      <p
                        className={`text-sm mt-1 ${darktheme ? "text-gray-400" : "text-gray-600"}`}
                      >
          ...
          >
            ...
            >
              ...
              exceptional performance, scalability, and reliability for millions
              of users:
            </motion.p>
          ...
          >
            ...
            >
              Experience the future of public transportation. Start tracking
              your buses and planning smarter journeys today.
            </p>
            <button
              onClick={() => navigate("/")}
